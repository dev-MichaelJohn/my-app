...
export type IOTPCodeSelect = z.infer<typeof OTPCodeSelect>;
export type IOTPCodeInsert = z.infer<typeof OTPCodeInsert>;
export type IOTPCodeUpdate = z.infer<typeof OTPCodeUpdate>;
