...
export const PERMISSIONS = {
  ...
  EVALUATION_PERIOD_CREATE: "evaluation-period:create",
  ...
  EVALUATION_REPORT_BATCH_GENERATE: "evaluation-report:batch-generate",
  ...
  ACCOUNT_CREATE_ADMIN: "account:create-admin", // SYS_ADMIN only
  ACCOUNT_MANAGE_ROLES: "account:manage-roles", // SYS_ADMIN only
  ACCOUNT_CREATE: "account:create", // Used by ADMIN for lower users
...
export const ROLE_PERMISSION_MATRIX: Record<RoleName, readonly Permission[]> = {
