...
import { CourseCurriculums, SemeterTermEnum, YearLevelEnum, } from "../schemas/institution.schema.js";
import z from "zod";
import { ProgramSelect } from "./program.type.js";
import { CourseSelect } from "./course.type.js";
const courseIdField = (schema) => schema.int("Course ID must be an integer.").positive("Please select a valid course.");
const programIdField = (schema) => schema.int("Program ID must be an integer.").positive("Please select a valid program.");
